                    ...
                    <div className="form-wrapper">
                        <form onSubmit={handleSubmit}>
                            <div className="form-group">
                                ...
                                <input type="text" placeholder="Enter email" name="email" id="email" value={data.email} onChange={handleChange} />
                            </div>

                            <div className="form-group">
                                <label htmlFor="password">Password</label>
                                <input type="password" placeholder="Enter password" name="password" id="password" value={data.password} onChange={handleChange} />
                            </div>

                            <button type="submit" className={`btn primary-btn ${ isSubmitting ? "inProcess" : "" }`} > {isSubmitting ? "Logging in..." : "Login"} </button>
                        </form>
                    </div>
                </div>
            </div>
