...
function ItemShiftTask() {
    ...
    function moveToLeft()
    {
        ...
        console.log("Selected Right Items: ", selectedRight);
			...
			<div className="card">
				...
				<div className="layout">
					...
					<div className="actions">
						<button className="actionBtn" onClick={moveToRight} >→</button>
						<button className="actionBtn" onClick={moveToLeft} >←</button>
					</div>
